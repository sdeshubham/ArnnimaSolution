      ...
      <div className="privacyComponent">
        ...
        <div className="privacyBox">
          <div className="privacyTop">
            ...
            <p>
              We, at Arnnima (OPC) PVT Limited , are committed to respecting
              your online privacy and recognize the need for appropriate
              protection and management of any personally identifiable
              information you share with us. This Privacy Policy ("Policy")
              describes how Arnnima collects, uses, discloses and transfers
              personal information of users through its websites and
              applications, including through www.arnnima.com, mobile
              applications and online services (collectively, the "Platform").
              This policy applies to those who visit the Platform, or whose
              information Arnnima otherwise receives in connection with its
              services (such as contact information of individuals associated
              with Arnnima including partners) (hereinafter collectively
              referred to as "Users"). For the purposes of the Privacy Policy,
              "You" or "Your" shall mean the person who is accessing the
              Platform.
            </p>
          </div>
          ...
          <div className="privacyContentBox">
            <div className="privacyContent">
              <label htmlFor="" className="privacyLabel">
                Types of Personal Information collected by Arnnima
              </label>
              <p>
                ...
                better services and offerings. The Personal Information that we
                collect, and how we collect it, depends upon how you interact
                with us. We collect the following categories of Personal
                Information in the following ways: name, email address,
                password, country, city, contact number and company/organization
                that you are associated with, when the you sign up for alerts on
                the Platform; information that one would usually include in a
                resume, including name, contact details including e-mail address
                and mobile number, work experience, educational qualifications,
                data relating to your current and past remuneration or salary, a
                copy of your resume, etc. when you register on the Platform;
                information about the services that you use and how you use
                them, including log information and location information, when
                you are a user of the services through the Platform; we may
                collect your Personal Information such as name, age, contact
                details, preferences, etc. through surveys and forms, when you
                choose to participate in these surveys etc.; we may also collect
                ...
                to sign in with your social media account to access the
            ...
            <div className="privacyContent">
              <label htmlFor="">
                How Arnnima may use your Personal Information
              </label>
              <p>
                We will only use your personal data in a fair and reasonable
                manner, and where we have a lawful reason to do so. Our use of
                your personal data depends on the purpose for which you interact
                with us. We may process your Personal Information for the
                following purposes: Providing our services and products to you
                including to send you job alerts, calendar alerts, relevant
                search results, recommended jobs and/or candidates (as the case
                maybe), and other social media communication facilities;
                Protecting our Users and providing you with customer support; We
                use information collected from cookies and other technologies,
                to improve your user experience and the overall quality of our
                services (for more information please refer to paragraph 4
                below). When showing you tailored ads, we will not associate an
                identifier from cookies or similar technologies with sensitive
                categories, such as those based on race, religion, sexual
                orientation or health. Improving the Platform and its content to
                provide better features and services. Conducting market research
                and surveys with the aim of improving our products and services.
                ...
                rights in connection with legal proceedings (including any
                prospective legal proceedings) and seeking professional or legal
                advice in relation to such legal proceedings.
              </p>
            </div>

            <div className="privacyContent">
              <label htmlFor="">Cookies and Other Tracking Technologies</label>
              <p>
                ...
                and how to remove them. You may set most browsers to notify you
                if you receive a cookie, or you may choose to block cookies with
                your browser, but please note that if you choose to erase or
                block your cookies, you will need to re-enter your original user
                ID and password to gain access to certain parts of the Platform.
                ...
                trends and statistics. For more information about our use of
                ...
                processing will only be performed where consent is secured.
              </p>
            </div>
            ...
            <div className="privacyContent">
              <label htmlFor="">Information Sharing and Disclosure</label>
              <p>
                ...
                operations and for provision of services aimed at helping you in
                your career enhancement; Potential recruiters if we determine
                ...
                court orders, or legal process, or to establish or exercise our
                ...
                obligations. Third party advertisers to display advertisements
                to you when you visit the Platform. The third-party advertisers
                include financial service providers (such as banks, insurance
                agents, stock brokers and mortgage lenders) and non-financial
                companies (such as stores, airlines, and software companies).
                These companies may use information about you and your visits to
                this Platform and other web sites to provide advertisements on
                this Platform. The Company does not provide any Personal
                Information to the advertiser when you interact with or view a
                targeted advertisement. However, if you interact with or view an
            ...
            <div className="privacyContent">
              <label htmlFor="">Third Party Content:</label>
              <p>
            ...
            <div className="privacyContent">
              <label htmlFor="">Employee/Employeer</label>
              <p>
                ...
                must use the Platform under the supervision of your parent,
            ...
            <div className="privacyContent">
              <label htmlFor="">Controlling your personal information</label>
              <p>
            ...
            <div className="privacyContent">
              ...
              <p>
                ...
                Act, 2000 and Rules made there under to ensure the protection
            ...
            <label htmlFor="">Cookie Policy</label>
            ...
            <div className="privacyContent">
              ...
              <p>
                ...
                visit or use our services, you are agreeing to the use of
                cookies and similar technologies for the purposes we describe in
                this policy. If you prefer not to receive cookies or web
                beacons, then you should stop using our site, or consult your
                browsing and third party cookie settings as described below.
              </p>
            </div>

            <div className="privacyContent">
              <label htmlFor="">What is a cookie?</label>
              <p>
                ...
                every request to the website. A cookie file is stored in your
                ...
                opened and acted upon. We may analyse or perform analysis based
                on the use of these technologies and generate reports on an
            ...
            <div className="privacyContent">
              <label htmlFor="">What are cookies used for?</label>
              <p>
                ...
                from page to page within the website. For example, we use
                cookies on our Websites to understand visitor and user
                ...
                Websites may be limited. We may use any of the following
                ...
                Websites, which site the user came from, the number of each
                user’s visits and how long a user stays on the Websites. We
                might also use analytics cookies to test new ads, pages, or
                features to see how users react to them. Functionality or
                Preference Cookies : During your visit to the Websites, cookies
            ...
            <div className="privacyContent">
              ...
              <p>
                ...
                technology will be disclosed to or collected directly by such
                service providers, who use the information to evaluate your use
                of the services. We also use Google Analytics for certain
                purposes related to online marketing, as described in the
                following sections. How are cookies used for advertising
                purposes? Cookies and other ad technology such as beacons,
                pixels, and tags help us serve relevant ads to you more
                effectively. They also help us provide aggregated auditing,
                research, and reporting for advertisers, understand and improve
                ...
                Network, Facebook for Advertisers, or other online advertising
            ...
            <div className="privacyContent">
              ...
              <p>
                ...
                services) may also use cookies on our Services. Cookies on our
                sites. Also, note that the names of cookies, pixels and other
                technologies may change over time. We also use Google Analytics
                on our Services to help us analyse how our Services are used.
                Google Analytics uses performance cookies to track customer’s
                interactions. For example, by using cookies, Google can tell us
                which pages our users view, which are most popular, what time of
                day our websites are visited, whether visitors have been to our
                websites before, what website referred the visitor to our
                websites, and other similar information. All of this information
                is anonymized.
              </p>
            </div>
            ...
            <div className="privacyContent">
              <label htmlFor="">How to control cookies?</label>
              <p>
                Most browsers allow you to control cookies through their
                settings preferences. However, if you choose to turn off these
                cookies, you will still see advertising on the internet but it
                may not be tailored to your interests. It does not mean that you
                won't be served any advertisements whilst you are online. Whilst
                we have mentioned most of the third parties involved in using
                targeting or advertising cookies in the preceding section , the
                list is not exhaustive and is subject to change. Therefore, even
                if you choose to turn off all the third-party cookies listed in
                section , you may still receive some tailored advertisements and
                recommendations. There are a number of ways you can manage what
                cookies are set on your devices. Essential cookies, however,
                cannot be disabled. If you do not allow certain cookies to be
                installed, the website may not be accessible to you and/or the
                performance, features, or services of the website may be
                compromised. You can also manage this type of cookie in the
                privacy settings on the web browser you are using. Please note
                that if you use your browser settings to block all cookies you
                may not be able to access parts of our or others' websites.
                Please see below for more information. Changing your Cookie
                Settings: The browser settings for changing your cookies
                settings are usually found in the 'options' or 'preferences'
                menu of your internet browser. In order to understand these
              ...
              <p>
                More information: To find out more about cookies, including how
